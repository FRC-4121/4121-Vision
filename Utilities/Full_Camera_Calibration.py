...
def mainloop():
    ...
    optcam_matrix, roi = cv.getOptimalNewCameraMatrix(
        cam_matrix, dist_coeffs, (img_width, img_height), 1, (img_width, img_height)
    )
    ...
    while True:
        ...
        new_img_undist = cv.undistort(
            new_img, cam_matrix, dist_coeffs, None, optcam_matrix
        )
